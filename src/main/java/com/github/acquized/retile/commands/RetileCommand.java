                        ...
                        if(!(sender instanceof ProxiedPlayer)) {
                            try {
                                ...
                                if(ProjectRetile.getInstance().getDbConfig().getString("Database.type").equalsIgnoreCase("MYSQL")) {
                                    ProjectRetile.getInstance().setDatabase(new MySQL("jdbc:mysql://" + ProjectRetile.getInstance().getDbConfig().getString("Database.MySQL.adress") + ":" + ProjectRetile.getInstance().getDbConfig().getLong("Database.MySQL.port") + "/" + ProjectRetile.getInstance().getDbConfig().getString("Database.MySQL.database"), ProjectRetile.getInstance().getDbConfig().getString("Database.MySQL.username"), ProjectRetile.getInstance().getDbConfig().getString("Database.MySQL.password").toCharArray()));
